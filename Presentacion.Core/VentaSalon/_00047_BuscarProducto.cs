...
{
    public partial class _00047_BuscarProducto : Form
    {
        ...
        public _00047_BuscarProducto(long _mesaId)
            : this(new ProductoServicio(), new ComprobanteSalonServicio())
        {
            InitializeComponent();
        ...
        public _00047_BuscarProducto(IProductoServicio productoServicio, IComprobanteSalonServicio comprobanteSalonServicio)
        {
        ...
        {
            grilla.DataSource = _productoServicio.ObtenerParaMesa(cadenaBuscar, mesaId);
        }
        ...
        private void _00047_BuscarProducto_Load(object sender, EventArgs e)
        {
