...
-- --------------------------------------------------
-- Date Created: 02/13/2020 12:29:08
-- Generated from EDMX file: C:\Users\braia\Desktop\XCommerce Final\XCommerce.AccesoDatos\ModeloXCommerce.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_ListaPrecioSalon]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Salones] DROP CONSTRAINT [FK_ListaPrecioSalon];
GO
...
IF OBJECT_ID(N'[dbo].[FK_TipoEmpleadoEmpleado]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Personas_Empleado] DROP CONSTRAINT [FK_TipoEmpleadoEmpleado];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_ComprobanteCtaCte_inherits_Comprobante]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Comprobantes_ComprobanteCtaCte] DROP CONSTRAINT [FK_ComprobanteCtaCte_inherits_Comprobante];
GO
...
GO
IF OBJECT_ID(N'[dbo].[TipoEmpleados]', 'U') IS NOT NULL
    DROP TABLE [dbo].[TipoEmpleados];
GO
...
GO
IF OBJECT_ID(N'[dbo].[Comprobantes_ComprobanteCtaCte]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Comprobantes_ComprobanteCtaCte];
GO
...
CREATE TABLE [dbo].[Empresas] (
    ...
    [CondicionIvaId1] bigint  NOT NULL,
    [CondicionIvaId2] bigint  NOT NULL,
    [Direccion_Id] bigint  NOT NULL
);
GO
...
CREATE TABLE [dbo].[Personas_Cliente] (
    ...
    [SaldoCtaCte] decimal(18,0)  NOT NULL,
    [FechaMaxPagoCtaCte] datetime  NULL,
    [Id] bigint  NOT NULL
);
GO
...
CREATE TABLE [dbo].[Personas_Empleado] (
    ...
    [TipoEmpleadoId1] bigint  NOT NULL,
    [Id] bigint  NOT NULL
);
GO
...
-- Creating table 'Comprobantes_ComprobanteCtaCte'
CREATE TABLE [dbo].[Comprobantes_ComprobanteCtaCte] (
    [Id] bigint  NOT NULL
);
GO
...
-- Creating primary key on [Id] in table 'TipoEmpleados'
ALTER TABLE [dbo].[TipoEmpleados]
ADD CONSTRAINT [PK_TipoEmpleados]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO
...
-- Creating primary key on [Id] in table 'Comprobantes_ComprobanteCtaCte'
ALTER TABLE [dbo].[Comprobantes_ComprobanteCtaCte]
ADD CONSTRAINT [PK_Comprobantes_ComprobanteCtaCte]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO
...
ALTER TABLE [dbo].[Salones]
ADD CONSTRAINT [FK_ListaPrecioSalon]
    FOREIGN KEY ([ListaPrecioId])
    REFERENCES [dbo].[ListaPrecios]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_ListaPrecioSalon'
CREATE INDEX [IX_FK_ListaPrecioSalon]
ON [dbo].[Salones]
    ([ListaPrecioId]);
GO

-- Creating foreign key on [CondicionIvaId2] in table 'Empresas'
ALTER TABLE [dbo].[Empresas]
ADD CONSTRAINT [FK_CondicionIvaEmpresa]
    FOREIGN KEY ([CondicionIvaId2])
...
-- Creating foreign key on [TipoEmpleadoId1] in table 'Personas_Empleado'
ALTER TABLE [dbo].[Personas_Empleado]
ADD CONSTRAINT [FK_TipoEmpleadoEmpleado]
    FOREIGN KEY ([TipoEmpleadoId1])
    REFERENCES [dbo].[TipoEmpleados]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO
...
-- Creating foreign key on [Id] in table 'Comprobantes_ComprobanteCtaCte'
ALTER TABLE [dbo].[Comprobantes_ComprobanteCtaCte]
ADD CONSTRAINT [FK_ComprobanteCtaCte_inherits_Comprobante]
    FOREIGN KEY ([Id])
    REFERENCES [dbo].[Comprobantes]
        ([Id])
    ON DELETE CASCADE ON UPDATE NO ACTION;
