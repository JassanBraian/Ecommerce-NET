...
{
    public partial class _00073_ComprobKioscoConsulta : FormularioConsulta
    {

        IkioscoServicio _kioscoServicio = new KioscoServicio();
        public _00073_ComprobKioscoConsulta()
        {
            InitializeComponent();
        ...
        {
            grilla.DataSource = _kioscoServicio.Obtener(cadenaBuscar);
        }
