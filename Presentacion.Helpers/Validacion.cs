...
namespace Presentacion.Helpers
{
    public class Validacion
    {
        ...
        public static void NoPuntos(object sender, KeyPressEventArgs e)
        {
            if (char.IsPunctuation(e.KeyChar) || char.IsSymbol(e.KeyChar) || Convert.ToInt32(e.KeyChar) == 46)
            {
                e.Handled = true;
            }
        }
        ...
        public static long UsuarioLogeado { get; set; }
