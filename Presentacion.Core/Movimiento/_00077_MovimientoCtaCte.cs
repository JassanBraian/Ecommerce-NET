...
{
    public partial class _00077_MovimientoCtaCte : FormularioConsulta
    {

        private readonly IMovimientoServicio _movimientoServicio = new MovimientoServicio();

        public _00077_MovimientoCtaCte()
        {
            InitializeComponent();
        ...
        {
            grilla.DataSource = _movimientoServicio.ObtenerCtaCte(cadenaBuscar);
        }
