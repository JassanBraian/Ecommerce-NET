...
{
    public partial class _00052_PagoKiosco : Form
    {

        private kioscoDto _comprobante = new kioscoDto();
        ...
        public _00052_PagoKiosco(kioscoDto comprobante)
        {
        ...
        private void _00052_PagoKiosco_Activated(object sender, EventArgs e)
        {
        ...
        private void btnPagar_Click(object sender, EventArgs e)
        {

            {
                    ...
                    case TipoFormaPago.CuentaCorriente:
                        {
                            ...
                            {
                                // Continua su curso sin realizar operacion
                            }
                            else
                            {
                ...
                _kioscoServicio.Pagar(nudDescuento.Value, nudSubTotal.Value, nudTotal.Value,
                    _comprobante.Id, _tipoFormaPago, (TipoComprobante)cmbTipoComprobante.SelectedItem);

                _kioscoServicio.Total(_comprobante.Id, nudDescuento.Value);

                switch (_tipoFormaPago)
                {
                    case TipoFormaPago.Tarjeta:
                        {
                            _kioscoServicio.FormaPagoTarjeta(
                    ...
                    case TipoFormaPago.CuentaCorriente:
                        {
                            _kioscoServicio.FormaPagoCtaCte(_comprobante.Clienteid);
                    ...
                    case TipoFormaPago.Cheque:
                        {
                            _kioscoServicio.FormaPagoCheque(((BancoDto)cmbBanco.SelectedItem).Id,
                                txtEmisor.Text, txtnumeroCheque.Text, Convert.ToInt32(nudDias.Value), dateTimeFechaEmision.Value);

                            break;
                        }
                    case TipoFormaPago.Efectivo:
                        {
                            _kioscoServicio.FormaPagoEfectivo();
        ...
        {
            var fCtaCte = new _00065_BuscarCtaCte();
            fCtaCte.ShowDialog();
        }
        ...
        private void btnNuevaTarjeta_Click_1(object sender, EventArgs e)
        {
        ...
        private void _00052_PagoKiosco_Load(object sender, EventArgs e)
        {
            CargarCmbFormaPago();
